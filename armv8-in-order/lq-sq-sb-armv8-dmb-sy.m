...
ruleset j : cores_t; i : LQ_idx_t do 
  rule "LQ build_packet_send_mem_request ===> build_packet_send_mem_request || build_packet_send_mem_request || await_mem_response || await_mem_response || build_packet_send_mem_request || await_mem_response || await_mem_response || await_creation || await_creation" 
...
begin
  ...
  if (next_state.core_[ j ].LQ_.entries[ i ].instruction.op = ld) then
    if is_instruction_on_any_state then
      ...
      while ((RENAME_offset < RENAME_difference) & ((RENAME_while_break = false) & (RENAME_found_entry = false))) do
        RENAME_curr_idx := ((RENAME_entry_idx + (RENAME_NUM_ENTRIES_CONST - RENAME_offset)) % RENAME_NUM_ENTRIES_CONST);
        if ((next_state.core_[ j ].RENAME_.entries[ RENAME_curr_idx ].instruction.seq_num < next_state.core_[ j ].LQ_.entries[ i ].instruction.seq_num) & (next_state.core_[ j ].RENAME_.entries[ RENAME_curr_idx ].instruction.op = dmb_ld)) then
          if (next_state.core_[ j ].RENAME_.entries[ RENAME_curr_idx ].state = issue_if_head) then
...
ruleset j : cores_t; i : ROB_idx_t do 
  rule "ROB rob_commit_if_head ===> rob_commit_if_head || rob_commit_if_head || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_commit_if_head || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation" 
...
ruleset j : cores_t; i : RENAME_idx_t do 
  rule "RENAME issue_if_head ===> issue_if_head || issue_if_head || issue_if_head || issue_if_head || issue_if_head || issue_if_head || issue_if_head || issue_if_head" 
