...
begin
  ...
  if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = st) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
...
begin
  ...
  if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = dmb_sy) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
    if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_load_result_write))) then
  ...
  if (next_state.core_[ j ].second_memory_stage_.instruction.op = st) then
    if is_instruction_on_any_state then
      ...
      if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = dmb_st) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
        if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_load_result_write))) then
      ...
      if (next_state.core_[ j ].second_memory_stage_.instruction.op = st) then
        if is_instruction_on_any_state then
          ...
          if ((next_state.core_[ j ].second_memory_stage_.instruction.op = stlr) & (next_state.core_[ j ].second_memory_stage_.instruction.seq_num != 0)) then
            if ((next_state.core_[ j ].second_memory_stage_.state = second_mem_unit_send) | (next_state.core_[ j ].second_memory_stage_.state = second_mem_unit_receive)) then
          ...
          if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = stlr) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
            if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_load_result_write))) then
...
begin
  ...
  if (next_state.core_[ j ].IQ_.entries[ i ].instruction.op = ld) then
    if is_instruction_on_any_state then
      ...
      if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = dmb_ld) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
        if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_load_result_write))) then
      ...
      if (next_state.core_[ j ].IQ_.entries[ i ].instruction.op = ld) then
        if is_instruction_on_any_state then
          ...
          if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = ldar) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num != 0)) then
            if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver)) then
