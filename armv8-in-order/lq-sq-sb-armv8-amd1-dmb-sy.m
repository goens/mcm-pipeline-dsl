...
ruleset j : cores_t; i : SB_idx_t do 
  rule "SB sb_await_send_mem_req ===> sb_await_send_mem_req || sb_await_mem_response || sb_await_mem_response" 
(((Sta.core_[ j ].SB_.entries[ i ].state = sb_await_send_mem_req) & !(Sta.core_[ j ].mem_interface_.out_busy)) & !(Sta.core_[ j ].mem_interface_.out_busy))
==>
...
ruleset j : cores_t; i : ROB_idx_t do 
  rule "ROB rob_commit_if_head ===> rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_await_creation || rob_commit_if_head || rob_await_creation || rob_await_creation" 
