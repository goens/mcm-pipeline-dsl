...
LSQ_state : enum {lsq_st_await_committed, lsq_ld_await_committed, lsq_ld_write_result, lsq_await_load_mem_response, lsq_build_packet_send_mem_request, lsq_ld_st_fwd_branch, lsq_await_translation, lsq_await_scheduled, lsq_await_creation, init_default_state, LoadReplay_await_replay_start, replay_issue_load_to_mem, replay_generated_lsq_await_load_mem_response, replay_compare_and_check_state};
