...
ruleset j : cores_t; i : ROB_idx_t do 
  rule "ROB rob_commit_based_on_inst ===> rob_commit_based_on_inst || ROB_await_replay_complete || original_commit_rob_commit_based_on_inst || rob_await_creation" 
...
begin
  ...
  while ((ROB_offset < ROB_difference) & ((ROB_while_break = false) & (ROB_found_entry = false))) do
    ...
    if ((next_state.core_[ j ].ROB_.entries[ ROB_curr_idx ].instruction.seq_num < next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num) & (next_state.core_[ j ].ROB_.entries[ ROB_curr_idx ].instruction.op = dmb_sy)) then
      if ((next_state.core_[ j ].ROB_.entries[ ROB_curr_idx ].state = rob_commit_if_head) | ((next_state.core_[ j ].ROB_.entries[ ROB_curr_idx ].state = rob_commit_based_on_inst) | (next_state.core_[ j ].ROB_.entries[ ROB_curr_idx ].state = rob_await_is_executed))) then
  ...
  for IQ_iter : IQ_idx_t do
    if next_state.core_[ j ].IQ_.entries[ IQ_iter ].valid then
      if ((next_state.core_[ j ].IQ_.entries[ IQ_iter ].instruction.seq_num < next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num) & (next_state.core_[ j ].IQ_.entries[ IQ_iter ].instruction.op = dmb_sy)) then
  ...
  if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = dmb_sy) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num < next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num)) then
  ...
  for IQ_iter : IQ_idx_t do
    if next_state.core_[ j ].IQ_.entries[ IQ_iter ].valid then
      if ((next_state.core_[ j ].IQ_.entries[ IQ_iter ].instruction.seq_num < next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num) & (next_state.core_[ j ].IQ_.entries[ IQ_iter ].instruction.op = dmb_ld)) then
        if (found_entry = false) then
          found_element := (next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num - next_state.core_[ j ].IQ_.entries[ IQ_iter ].instruction.seq_num);
          found_idx := IQ_iter;
        else
  ...
  if ((next_state.core_[ j ].memory_unit_sender_.instruction.op = dmb_ld) & (next_state.core_[ j ].memory_unit_sender_.instruction.seq_num < next_state.core_[ j ].ROB_.entries[ i ].instruction.seq_num)) then
    if ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_stage_send) | ((next_state.core_[ j ].memory_unit_sender_.state = memory_unit_receiver) | (next_state.core_[ j ].memory_unit_sender_.state = memory_unit_load_result_write))) then
  ...
  is_instruction_on_any_state := (ROB_dmb_sy_is_in_state_set | (IQ_dmb_sy_is_in_state_set | (memory_unit_sender_dmb_sy_is_in_state_set | (ROB_dmb_ld_is_in_state_set | (IQ_dmb_ld_is_in_state_set | memory_unit_sender_dmb_ld_is_in_state_set)))));
...
ruleset j : cores_t; i : ROB_idx_t do 
  rule "ROB original_commit_rob_commit_based_on_inst ===> rob_await_creation || rob_wait_store_completed" 
...
ruleset j : cores_t do 
  rule "memory_unit_sender replay_compare_and_check_state ===> mem_unit_send_get_input" 
