...
begin
  ...
  alias rename_c0 : init_state.core_[ 0 ].RENAME_ do
    ...
    rename_c0.entries[ 1 ].instruction.op := dmb_sy;
  ...
  alias rename_c1 : init_state.core_[ 1 ].RENAME_ do
    ...
    rename_c1.entries[ 1 ].instruction.op := dmb_sy;
    ...
    rename_c1.entries[ 2 ].instruction.op := st;
    rename_c1.entries[ 2 ].instruction.seq_num := 3;
    rename_c1.entries[ 2 ].instruction.dest_reg := 1;
    rename_c1.entries[ 2 ].instruction.imm := 1;
    rename_c1.entries[ 2 ].instruction.write_value := 1;
    rename_c1.head := 0;
