...
ROB_state : enum {rob_complete_store, rob_wait_store_completed, rob_received_load_replay, rob_wait_load_replay, rob_commit_if_head, rob_await_is_executed, rob_await_creation, init_rob_entry};
...
ruleset j : cores_t; i : ROB_idx_t do 
  rule "ROB rob_commit_if_head ===> rob_commit_if_head || rob_commit_if_head || rob_wait_load_replay || rob_wait_store_completed || rob_commit_if_head || rob_await_is_executed" 
