...
type ---- Type declarations ----
  ...
  let hp_load_replay_await_load_mem_resp_function := List.join [
    [murϕ_proc_decl|
...
begin
  ...
  let hp_in_order_await_load_mem_resp_function := List.join [
    [murϕ_proc_decl|
    function associative_assign_lq (
      lq : LQ;
      msg : MEM_REQ
    ...
    let hp_await_store_mem_response_fn := List.join [
    [murϕ_proc_decl|
  ...
  let listen_handler_init := [murϕ_statement|
  ...
  let lat_alias_init := [murϕ_statement|
...
begin
  ...
  let core_gets_msg_including_inval_rule :=
    [murϕ_rule|
  ...
  let core_gets_msg_not_inval_rule :=
    [murϕ_rule|
