...
begin
  ...
  alias rename_c0 : init_state.core_[ 0 ].RENAME_ do
    ...
    rename_c0.entries[ 2 ].instruction.dest_reg := 0;
  ...
  alias rename_c1 : init_state.core_[ 1 ].RENAME_ do
    ...
    rename_c1.entries[ 1 ].instruction.seq_num := 1;
    ...
    rename_c1.entries[ 2 ].instruction.seq_num := 1;
...
begin
  ...
  if ((next_state.core_[ j ].second_memory_stage_.instruction.op = st) & is_instruction_on_any_state) then
    next_state.core_[ j ].second_memory_stage_.state := second_mem_unit_send;
    return ;
  else
