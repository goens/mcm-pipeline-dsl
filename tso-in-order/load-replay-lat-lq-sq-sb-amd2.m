...
& (Sta.core_[ 0 ].SB_.num_entries = 0) & (Sta.core_[ 1 ].SB_.num_entries = 0)) -> !((((Sta.core_[ 0 ].rf_.rf[ 0 ] = 1) & (Sta.core_[ 0 ].rf_.rf[ 1 ] = 0)) & ((Sta.core_[ 1 ].rf_.rf[ 0 ] = 1) & (Sta.core_[ 1 ].rf_.rf[ 1 ] = 0)))));
